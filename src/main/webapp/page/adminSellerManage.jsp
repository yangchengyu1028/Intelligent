                ...
                <div class="span12" style="padding-left: 2%;padding-right:2%">
                    ...
                    <div class="portlet paddingless">
                        <div class="portlet-title line">
                            <div class="caption"><i class="icon-bell"></i>上游商家</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="tabbable tabbable-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="" data-toggle="tab" id="relevanced" index="1">入驻商家</a>
                                    </li>
                                    <li>
                                        <a href="" data-toggle="tab" id="norelevance" index="0">未入驻商家</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="portlet-body">
                        ...
                        <div class="row-fluid">
                        	 <div class="span6">
                                 <input type='button'  value='添加入驻商家' class="btn"  data-target='#myModa1' data-toggle='modal' />
                             </div>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabe">新对接商家</h4>
									</div>
									...
									<div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" id="backBtn1" data-dismiss="modal">返回</button>
                               		</div>
								</div>
								<!-- /.modal-content -->
							</div>
                                      ...
                                      /*   bkLib.onDomLoaded(function() { nicEditors.allTextAreas() }); */
										...
										function matching(id) {
											if(confirm("确定入驻该商家么?")){
												$.ajax({
													method : "post",
													url : "matchingSellerOfAdmin.novo",
													data : {
														"id": id
													},
													async : true,
										...
										function relevanceDetails(id) {
											window.location.href = "adminSellerDetails.novo?id="+id;
										}
										<!--添加商家-->

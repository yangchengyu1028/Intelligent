                ...
                <div class="span12" style="padding-left: 2%;padding-right:2%">
                    ...
                    <div class="portlet paddingless">
                        <div class="portlet-title line">
                            <div class="caption"><i class="icon-bell"></i>买家绑定商家管理</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="tabbable tabbable-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="" data-toggle="tab" id="relevanced" index="1">已绑定商家</a>
                                    </li>
                                    <li>
                                        <a href="" data-toggle="tab" id="norelevance" index="0">未绑定商家</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="portlet-body">
                                    ...
                                    <script>
                                      ...
                                      /*   bkLib.onDomLoaded(function() { nicEditors.allTextAreas() }); */
										...
										function show() {
											...
											$.ajax({
												method : "post",
												url : "getSellerByBuyerOfAdmin.novo",
												data : {
													"pageNo" : pageNo,
													"pageSize" : "10",
													"name" : name,
												...
												success : function(pageBean) {
													...
													if(marryState=="1"){
														for (var i = 0; i < pageBean.list.length; i++) {
															str += "<tr><td>"
																+ pageBean.list[i].user.realName
		            											+ "</td><td>"
		            											+ pageBean.list[i].supplier.name
		            											+ "</td><td>"
		            											+ pageBean.list[i].supplier.id
		            											+ "</td><td>"
		            											+ pageBean.list[i].supplier.mobile
		            											+ "</td><td><input type='button' onclick='cancel("
		            											+ pageBean.list[i].id
		            											+ ")' class='btn' value='取消绑定'/></td></tr>";
														}
													}else{
														for (var i = 0; i < pageBean.list.length; i++) {
															str += "<tr><td>"
										...
										function cancel(id) {
												...
												$.ajax({
													method : "post",
													url : "cancelBuyerAndSellerRelevanceOfAdmin.novo",
													data : {
														"id": id
													},
													async : true,
										...
										function matching(id) {
												...
												$.ajax({
													method : "post",
													url : "matchingBuyerAndSellerRelevanceOfAdmin.novo",
													data : {
														"id": id
													},
													async : true,

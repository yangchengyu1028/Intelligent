                ...
                <div class="span12" style="padding-left: 2%;padding-right:2%">
                    ...
                    <div class="portlet paddingless">
                        <div class="portlet-title line">
                            <div class="caption"><i class="icon-bell"></i>商家绑定买家管理</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="tabbable tabbable-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="" data-toggle="tab" id="relevanced" index="1">已绑定买家</a>
                                    </li>
                                    <li>
                                        <a href="" data-toggle="tab" id="norelevance" index="0">未绑定买家</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="portlet-body">
                                    ...
                                    <script>
                                      ...
                                      /*   bkLib.onDomLoaded(function() { nicEditors.allTextAreas() }); */
										...
										function show() {
											...
											$.ajax({
												method : "post",
												url : "getBuyerBySellerOfAdmin.novo",
												data : {
													"pageNo" : pageNo,
													"pageSize" : "10",
													"name" : name,
													"marryState" : marryState,
													"supplierId":$("#hidden2").val()
												},
												async : true,
												success : function(pageBean) {
													...
													if(marryState=="1"){
														for (var i = 0; i < pageBean.list.length; i++) {
	            											...
	            											+ "</td><td>"
	            											+ pageBean.list[i].user.id
	            											+ "</td><td>"
	            											+ pageBean.list[i].user.phone

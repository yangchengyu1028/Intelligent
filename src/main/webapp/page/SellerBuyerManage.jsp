            ...
            <ul class="nav pull-right">
                <li class="dropdown user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="username">${sessionScope.supplier.name}</span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="outloginOfSeller.novo"><i class="icon-key"></i> 退出登陆</a>
                        </li>
                    </ul>
                </li>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="tabbable tabbable-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="" data-toggle="tab" id="relevanced" index="1">对其可见</a>
                                    </li>
                                    <li>
                                        <a href="" data-toggle="tab" id="norelevance" index="0">对其不可见</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="portlet-body">
                                    ...
                                    <script>
                                      ...
                                      /*   bkLib.onDomLoaded(function() { nicEditors.allTextAreas() }); */
										...
										function getVal() {
											pageNo = $("#pageNo").val();
											name = $("#name").val();
											sellerState = $("#hidden1").val();
										};
										function show() {
											getVal();
											$.ajax({
												method : "post",
												url : "getBuyerOfSeller.novo",
												data : {
													"pageNo" : pageNo,
													"pageSize" : "10",
													"name" : name,
